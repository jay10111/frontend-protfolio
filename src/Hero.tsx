...
function Hero() {
 ...
 <div className="border-2 border-white-600"><img src="IMG_0231.jpg" alt="" width={550} /></div>
 </div>
<div className="my-40">
   <div className="-mb-5 font-serif text-[20px]"><p>Hello, I'm Jayraj</p></div>
   <div className="text-[80px] -mb-10 font-bold -mx-10 text-[#A6BBCC] ">Frontend</div>
   <div className="text-[80px] font-bold text-[#A6BBCC]">Developer</div>
   <a href="/Jayraj_resume.pdf" download="Jayraj_resume.pdf" ><div className="underline underline-offset-8 hover:text-[#A6BBCC]">Dowload Resume</div></a>

   <div id="about" >
        <h1 className="font-bold text-[70px] underline underline-offset-8 text-left mt-55   text-[#A6BBCC]">about</h1> <br />

        <div className="text-left  "><p> They also focus on optimizing performance and accessibility, ensuring that all users, regardless of their abilities or devices, can navigate and interact with the web applications effectively.  Additionally, frontend developers often utilize version control systems like Git to manage code changes and collaborate with team members efficiently, fostering a productive development environment.</p></div> <br />

      <div className=" gap-20  font-extrabold text-[30px] text-left " >
        <h1>⦾ React.js</h1> 
        <h1>⦾ Javascript</h1>
        <h1>⦾ Web Desing</h1>
     ...
     <div id='work'>
        <h1 className="font-bold text-[70px] underline underline-offset-8 text-left   text-[#A6BBCC]">Work</h1> <br />

        <div className="text-left  "><p> Developed responsive web applications using HTML, CSS, and JavaScript, ensuring optimal performance across various devices and browsers.

Collaborated with UX/UI designers to create user-friendly interfaces that enhance user experience and engagement.Optimized website performance by employing best practices in coding, image compression, and lazy loading techniques, resulting in faster load times.

Conducted thorough testing and debugging of applications to ensure cross-browser compatibility and adherence to web standards.

</p></div> <br />

          <h1 className="text-[30px] font-extrabold text-[#A6BBCC]">My Projects</h1> <br />

          <div className="font-bold text-[20px] text-left">1.Car website(using HTML,CSS,BOOTSTRAP)</div> <br />

          <div className="border-2 border-white-600"><img src="p1.png" alt="" /></div>
         
        

        <br /><br />

<div className="font-bold text-[20px] text-left">2.Jewellery Website(using HTML,CSS,BOOTSTRAP,JAVASCRIPT)</div> <br />

<div className="border-2 border-white-600"><img src="p2.png" alt="" /></div> <br />

<h1 className="font-bold text-[70px] underline underline-offset-8 text-left   text-[#A6BBCC]" id='con'>Contact Me</h1> 


<div className="bg-black text-white flex items-center justify-center min-h-screen -mt-60 ">
<div className="container mx-auto p-5">
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
<div className="bg-gray-900 p-6 rounded-lg shadow-lg">
                <div className="text-green-500 text-4xl mb-4">☎️</div>
                <p className="text-lg font-semibold">+91 9510914017</p>
                <p className="text-gray-400">Contact Phone</p>
            </div>

            <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
                <div className="text-green-500 text-4xl mb-4">✉️</div>
                <p className="text-lg font-semibold">jayrajzinzala95@gmail.com</p>
                <p className="text-gray-400">Contact Email</p>
            </div>

            <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
                <div className="text-green-500 text-4xl mb-4">📍</div>
                <p className="text-lg font-semibold">Surat, Gujarat, India</p>
...
<div className="container mx-auto px-5 py-24 -mt-60">
...
<footer className="w-full py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                    ...
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200 text-[white]">
                ...
                <a href="#con" className="text-white hover:text-gray-200">Contact Me</a>
                    ...
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        ...
                        <a href="https://www.instagram.com/jayraj_zinzala/" className="block  text-gray-900 transition-all duration-500 hover:text-indigo-600 ">
                    ...
                    <span className="text-lg text-gray-500 text-center block">©<a href="">jayraj</a> 2024, All rights reserved.</span>
            </div>
        </div>
    </footer>
